...
public class PlaceController {
    ...
    public ResponseEntity<Long> createPlaceRecommendation(
            ...
            @Parameter(description = "Request para salvar o local")
    ...
    @Operation(
            ...
            description = "Returns up to 5 places closest to the given coordinates. Latitude and longitude are required."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de lugares obtida com sucesso", content = @Content(
